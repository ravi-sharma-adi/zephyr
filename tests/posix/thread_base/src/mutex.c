...
ZTEST(posix_thread_base, test_mutex_prioceiling_stubs)
{
 ...
 *	    normal.
 */
ZTEST(posix_thread_base, test_mutex_normal)
{
 ...
 *
 */
ZTEST(posix_thread_base, test_mutex_recursive)
{
 ...
 */
ZTEST(posix_thread_base, test_mutex_resource_exhausted)
{
	size_t i;
 ...
 */
ZTEST(posix_thread_base, test_mutex_resource_leak)
{
	pthread_mutex_t m;
...
ZTEST(posix_thread_base, test_mutex_timedlock)
{
	void *ret;
	pthread_t th;

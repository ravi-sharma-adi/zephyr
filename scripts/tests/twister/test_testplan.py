...
TESTDATA_EXCLUSION_FAKEPLANS = {
    ...
    'twister_1.json': {
        'testsuites': [
              { 'name': 'tests/foo/bar/baz.feature1', 'platform': 'qemu_foo', 'runnable': True, 'status': 'failed' }
        ]
    },
    'testplan_2.json': {
        'testsuites': [
    ...
    'twister_2.json': {
        'testsuites': [
              { 'name': 'tests/foo/bar/baz.feature1', 'platform': 'qemu_foo', 'runnable': False, 'status': 'passed' },
              { 'name': 'tests/foo/bar/baz.feature1', 'platform': 'qemu_foo_64', 'runnable': True, 'status': 'failed' },
              { 'name': 'tests/foo/bar/baz.feature2', 'platform': 'qemu_foo', 'runnable': True, 'status': 'failed'  }
        ]
    },
    'testplan_3.json': {
        'testsuites': [
              { 'name': 'tests/foo/bar/baz.feature1', 'platform': 'qemu_foo', 'runnable': True },
              { 'name': 'tests/foo/bar/baz.feature2', 'platform': 'qemu_foo', 'runnable': True },
              { 'name': 'tests/foo/bar/baz.feature1', 'platform': 'qemu_bar', 'runnable': True }
        ]
    }
}
...
TESTDATA_EXCLUSION_PLANS = [
  ...
  ( 'testplan_1.json',
    ...
    { 'qemu_foo/tests/foo/bar/baz.feature1': ('exact', ['testplan_1.json']) }
  ),
  ...
  ( 'testplan_1.json',
    ...
    { 'qemu_foo/tests/foo/bar/baz.feature1': ('exact', ['testplan_1.json', 'testplan_1.json']) }
  ),
  ...
  ( 'testplan_1.json',
    ...
    { 'qemu_foo/tests/foo/bar/baz.feature1': ('exact', ['testplan_2.json']) }
  ),
  ...
  ( 'testplan_1.json',
    ...
    { 'qemu_foo/tests/foo/bar/baz.feature1': ('exact', ['twister_2.json'], {'passed'}, {'passed'}) }
  ),
 ...
 # run_1_0 - single running rule - clears the same test with the same runnable state.
  ( 'testplan_1.json',
    ...
    { 'qemu_foo/tests/foo/bar/baz.feature1': ('run', ['testplan_1.json']) }
  ),
  ...
  ( 'testplan_1.json',
    ...
    { 'qemu_foo/tests/foo/bar/baz.feature1': ('run', ['testplan_2.json']) }
  ),
  ...
  ( 'testplan_1.json',
    ...
    { 'qemu_foo/tests/foo/bar/baz.feature1': ('run', ['testplan_1.json', 'testplan_2.json']) }
  ),
  ...
  ( 'testplan_2.json',
    ...
    {
      'qemu_foo/tests/foo/bar/baz.feature1': ('run', ['testplan_1.json']),
      'qemu_foo_64/tests/foo/bar/baz.feature1': ('run', ['testplan_1.json'])
    }
  ),
  ...
  ( 'testplan_1.json',
    ...
    {
      'qemu_foo/tests/foo/bar/baz.feature1': ('run', ['twister_2.json'], {'failed'}, {'failed'})
    }
  ),
  ...
  ( 'testplan_1.json',
    ...
    {
      'qemu_foo/tests/foo/bar/baz.feature1': ('run', ['twister_2.json'], {'passed'}, {'passed'})
    }
  ),
  ...
  ( 'testplan_2.json',
    ...
    {
      'qemu_foo/tests/foo/bar/baz.feature1': ('run', ['twister_1.json'], {'failed'}, {'failed'}),
      'qemu_foo_64/tests/foo/bar/baz.feature1': ('run', ['twister_1.json'], {'failed'}, {'failed'})
    }
  ),
 # platform_1_0 - single rule - clears the same test.
  ( 'testplan_1.json',
    ...
    { 'qemu_foo/tests/foo/bar/baz.feature1': ('platform', ['testplan_1.json']) }
  ),
  ...
  ( 'testplan_1.json',
    ...
    { 'qemu_foo/tests/foo/bar/baz.feature1': ('platform', ['testplan_1.json', 'testplan_2.json']) }
  ),
  ...
  ( 'testplan_1.json',
    ...
    {
      'qemu_foo/tests/foo/bar/baz.feature1': ('platform', ['twister_2.json'], {'passed'}, {'passed'})
    }
  ),
  ...
  ( 'testplan_2.json',
    ...
    {
      'qemu_foo_64/tests/foo/bar/baz.feature1': ('platform', ['twister_2.json'], {'failed'}, {'failed'}),
      'qemu_foo/tests/foo/bar/baz.feature2': ('platform', ['twister_2.json'], {'failed'}, {'failed'})
    }
  ),
  ...
  ( 'testplan_1.json',
    ...
    { 'qemu_foo/tests/foo/bar/baz.feature1': ('name', ['testplan_1.json']) }
  ),
  ...
  ( 'testplan_1.json',
    ...
    { 'qemu_foo/tests/foo/bar/baz.feature1': ('name', ['testplan_1.json', 'testplan_2.json', 'testplan_2.json']) }
  ),
  ...
  ( 'testplan_2.json',
    ...
    {
      'qemu_foo/tests/foo/bar/baz.feature1': ('name', ['testplan_1.json']),
      'qemu_foo_64/tests/foo/bar/baz.feature1': ('name', ['testplan_1.json'])
    }
  ),
  ...
  ( 'testplan_1.json',
    ...
    {
      'qemu_foo/tests/foo/bar/baz.feature1': ('name', ['twister_2.json', 'twister_2.json'], {'passed','failed'}, {'passed'})
    }
  ),
  ...
  ( 'testplan_2.json',
    ...
    },
    {
      ...
      'qemu_foo_64/tests/foo/bar/baz.feature1': ('name', ['twister_2.json', 'twister_2.json'], {'passed', 'failed'}, {'passed'})
      # .. whereas 'baz.feature2' should not be excluded:
      # qemu_foo/tests/foo/bar/baz.feature2: NOT Excluded by 'NAME' testplans:['twister_2.json'],
  ...
  ( 'testplan_2.json',
    ...
    },
    {
      ...
      'qemu_foo/tests/foo/bar/baz.feature1': ('name', ['twister_2.json', 'twister_2.json'], {'passed', 'failed'}, {'failed'}),
      'qemu_foo_64/tests/foo/bar/baz.feature1': ('name', ['twister_2.json', 'twister_2.json'], {'passed', 'failed'}, {'failed'}),
      'qemu_foo/tests/foo/bar/baz.feature2': ('name', ['twister_2.json'], {'failed'}, {'failed'})
    }
  ),
  ...
  ( 'testplan_2.json',
    ...
    {
      'qemu_foo/tests/foo/bar/baz.feature1': ('name', ['twister_2.json', 'twister_2.json'], {'passed','failed'}, {'passed', 'failed'}),
      'qemu_foo_64/tests/foo/bar/baz.feature1': ('name', ['twister_2.json', 'twister_2.json'], {'passed','failed'}, {'passed', 'failed'}),
      'qemu_foo/tests/foo/bar/baz.feature2': ('name', ['twister_2.json'], {'failed'}, {'passed', 'failed'})
    }
  ),
  ...
  ( 'testplan_1.json',
    ...
    { 'qemu_foo/tests/foo/bar/baz.feature1': ('platform', ['testplan_3.json']) }
  )
]  # TESTDATA_EXCLUSION_PLANS
...
def test_exclusion_plans(current_testplan_fname, is_runnable, testplan_files, testplan_statuses,
    ...
    for flt_type in EXCLUDE_TYPES:
        in_options["exclude_plan_" + flt_type] = testplan_files[flt_type] if flt_type in testplan_files else []
        tp_files += testplan_files[flt_type] if flt_type in testplan_files else []
    ...
    for flt_type in EXCLUDE_TYPES:
        assert testplan.exclusion_plans[flt_type]['filters'] == ( expected_rules[flt_type] if flt_type in expected_rules else {} )

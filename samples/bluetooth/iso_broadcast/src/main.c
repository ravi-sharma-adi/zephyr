...
int main(void)
{
	 ...
	 */
	const uint16_t adv_interval_ms = 60;
	const struct bt_le_adv_param *ext_adv_param =
		BT_LE_ADV_PARAM(BT_LE_ADV_OPT_EXT_ADV, BT_GAP_MS_TO_ADV_INT(adv_interval_ms - 10),
				BT_GAP_MS_TO_ADV_INT(adv_interval_ms - 10), NULL);
	const struct bt_le_per_adv_param *per_adv_param = BT_LE_PER_ADV_PARAM(
		BT_GAP_MS_TO_PER_ADV_INT(adv_interval_ms),
		BT_GAP_MS_TO_PER_ADV_INT(adv_interval_ms), BT_LE_PER_ADV_OPT_NONE);
